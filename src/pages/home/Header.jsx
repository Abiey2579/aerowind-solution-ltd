...
const Header = () => {
  return (
    <main>
      <div className="flex relative px-6 lg:px-8">
        <div className="max-w-2xl pt-20 pb-32 sm:pt-48 sm:pb-40">
        ...
        <div class="lg:flex flex-shrink-0 justify-center items-center">
          <img
            src={AEROPLANE}
            alt="AEROPLANE"
